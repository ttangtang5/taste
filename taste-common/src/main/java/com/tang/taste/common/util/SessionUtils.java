 ...
 * @Author:   16
 * Date:     2018/3/21 11:59
 * Description:session工具类
 */
public class SessionUtils {

    protected static final Logger logger = Logger.getLogger(String.valueOf(SessionUtils.class));

    private static final String SESSION_USER = "session_user";

    private static final String SESSION_VALIDATECODE = "session_captcha";//验证码


    private static final String SESSION_ACCESS_URLS = "session_urls"; //系统能够访问的URL
